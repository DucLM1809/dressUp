    ...
    <div className='w-full'>
      ...
      <div className='w-full flex flex-col items-center'>
        ...
        <div className='flex flex-wrap items-center justify-evenly'>
          <img
            src={BRAND}
            className='h-[100px] md:w-1/5 md:h-[250px] object-contain'
          />
          <img
          ...
          <img
            ...
            className='h-[100px] md:w-1/5 hidden md:block md:object-contain '
          />
          <img
            src='http://static.ybox.vn/2021/4/5/1619164610596-1565852925742-Logo-black-white-01.png'
            className='w-1/5 h-[250px] object-contain hidden md:block'
          />
          <img
      ...
      <div className='mt-4 w-full hidden md:flex items-center p-10'>
        <div>
          <img
      ...
      <div className='bg-[#FDEDED] w-full flex flex-col items-center'>
        <div className='text-2xl my-8 md:my-12 font-medium'>KNOWLEDGES</div>
        <div className='w-full md:px-20 flex md:flex-row flex-col items-center justify-between'>
          <Thumbnail src='https://i.pinimg.com/564x/9a/7a/19/9a7a19e74667aee85cc133a196b14c0c.jpg' />
          <Thumbnail src='https://i.pinimg.com/564x/8d/9b/1e/8d9b1ef1486033ec83ac70b2d30f50be.jpg' />
          <Thumbnail src='https://i.pinimg.com/564x/a7/01/3e/a7013e992a5a6e5e5146cb55fcdc86ab.jpg' />
      ...
      <div className='mt-4 w-full flex flex-col md:flex-row items-center p-10 md:hidden'>
